...
<template>
  <section class="trips-panel">
    <view class="panel-heading">
      <view><text class="panel-eyebrow">{{ t('admin.trips.eyebrow') }}</text><text class="panel-title">{{ t('admin.trips.title') }}</text></view><button :disabled="loading" :title="t('admin.trips.refresh')" @click="load">
