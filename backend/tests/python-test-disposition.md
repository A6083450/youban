...
| 185 | `app/models/schemas_test.py:85::test_trip_request_defaults_rooms_to_two_travelers_per_room` | `replace` | tests/domain-schemas.test.ts, ../frontend/src/features/result/model.test.ts | DTO 严格性与展示蓝图兼容分别在后端和统一前端边界验证 |
| 186 | `app/models/schemas_test.py:97::test_accepts_blueprint_and_reference_times` | `replace` | tests/domain-schemas.test.ts, ../frontend/src/features/result/model.test.ts | DTO 严格性与展示蓝图兼容分别在后端和统一前端边界验证 |
| 187 | `app/models/schemas_test.py:103::test_keeps_legacy_plan_without_blueprint` | `replace` | tests/domain-schemas.test.ts, ../frontend/src/features/result/model.test.ts | DTO 严格性与展示蓝图兼容分别在后端和统一前端边界验证 |
| 188 | `app/models/schemas_test.py:115::test_normalizes_invalid_times_without_rejecting_plan` | `replace` | tests/domain-schemas.test.ts, ../frontend/src/features/result/model.test.ts | DTO 严格性与展示蓝图兼容分别在后端和统一前端边界验证 |
| 189 | `app/models/schemas_test.py:123::test_discards_blueprint_with_duplicate_or_missing_days` | `replace` | tests/domain-schemas.test.ts, ../frontend/src/features/result/model.test.ts | DTO 严格性与展示蓝图兼容分别在后端和统一前端边界验证 |
| 190 | `app/models/schemas_test.py:129::test_limits_each_blueprint_stage_to_three_highlights` | `replace` | tests/domain-schemas.test.ts, ../frontend/src/features/result/model.test.ts | DTO 严格性与展示蓝图兼容分别在后端和统一前端边界验证 |
