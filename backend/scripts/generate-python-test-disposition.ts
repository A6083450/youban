...
const backendRoot = resolve(import.meta.dir, "../../backend.bak");
...
const rules: Record<string, Rule> = {
  ...
  "app/models/schemas_test.py": replace("tests/domain-schemas.test.ts, ../frontend/src/features/result/model.test.ts", "DTO 严格性与展示蓝图兼容分别在后端和统一前端边界验证"),
