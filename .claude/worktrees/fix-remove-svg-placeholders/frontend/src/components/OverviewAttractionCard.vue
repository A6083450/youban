<template>
  <div class="swiper-slide" :class="{ 'swiper-slide-active': active }" @mouseenter="emit('hover')" @focusin="emit('hover')">
    <div class="swiper-slide-img">
      <img v-if="imageSrc" :src="imageSrc" :alt="item.name" loading="lazy" @error="emit('image-error', $event)" />
...
.swiper-slide {
  ...
  box-shadow: 0.063rem 0.5rem 1.25rem rgba(61, 50, 41, 0.12);
  ...
  &-content {
    ...
    .show-more {
      ...
      background: #D97757;
      border-radius: 50%;
      box-shadow: 0px 0.125rem 0.875rem rgba(217, 119, 87, 0.4);
      margin-top: 1em;
      margin-bottom: 0.8em;
      height: 0;
      opacity: 0;
